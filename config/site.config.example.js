...
export default {
  // Basic Site Info
  site: {
    name: "MODEL_NAME",                    // Model display name
    domain: "model-domain.com",            // Domain without https://
    url: "https://model-domain.com",       // Full URL with https://
    language: "de",
    locale: "de_DE"
  },
  ...
  // Model Information
  model: {
    id: "MODEL_ID",                        // MyDirtyHobby ID (from profile URL)
    name: "MODEL_NAME",                    // Display name
    username: "MODEL_USERNAME",            // MDH username
    tagline: "Dein heißes Girl von nebenan",

    // Profile URL (with your affiliate tracking)
    profileUrl: "https://www.mydirtyhobby.de/profil/MODEL_ID-MODEL_USERNAME",
  ...
  feed: {
    ...
    url: "https://www.mydirtyhobby.com/api/amateurvideos/?amateurId=MODEL_ID&ats=ATS_TOKEN&limit=200&offset=0&language=de&aboutme=1&softcore=hardcore",
    cacheFile: "data/videos.json",
    refreshInterval: 6,
    videoBaseUrl: "https://www.mydirtyhobby.de/video/",
    // Tracking parameters for all MDH links
    trackingParams: {
      ats: "ATS_TOKEN",                    // Your affiliate tracking string
      ad_id: "API",
      atc: "model-domain-com"              // Unique identifier (domain with dashes)
    }
  },
